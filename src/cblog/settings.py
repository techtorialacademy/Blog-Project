...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Admin12345',
        'HOST': 'database-1.c3bhgefoqgp7.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blog-bucket-tech' # please enter your s3 bucket name
