...
DATABASES = {
    'default': {
        ...
        'HOST': 'blog-rds.chs2jc50cfzy.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'myblogbucket-eser' # please enter your s3 bucket name
