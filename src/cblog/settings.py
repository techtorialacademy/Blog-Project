...
DATABASES = {
    'default': {
        ...
        'HOST': 'http://database-1.cewvxnnnahzx.us-east-1.rds.amazonaws.com/',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blogtechtorial' # please enter your s3 bucket name
